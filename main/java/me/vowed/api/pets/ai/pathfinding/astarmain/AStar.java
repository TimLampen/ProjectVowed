...
public class AStar {
    ...
    public AStar(Location start, Location end, int range) throws InvalidPathException {
        ...
        FollowOwner.ownerLocation = end;
        FollowOwner.xINT = end.getBlockX();
        FollowOwner.y = end.getBlockY();
        FollowOwner.z = end.getBlockZ();
    }
    ...
    private boolean isTileWalkable(Tile t) {
        ...
        if (i != 8 && i != 9 && i != 10 && i != 11 && i != 51 && i != 59 && i != 0 && i != 85 && i != 107 && i != 113 && !canBlockBeWalkedThrough(i)) {
    ...
    private boolean isLocationWalkable(Location l) {
        ...
        if (i != 8 && i != 9 && i != 10 && i != 11 && i != 51 && i != 59 && i != 0 && !canBlockBeWalkedThrough(i)) {
